...
function taxi_transfer_scripts() {
    ...
    // wp_enqueue_style('datepicker-css-time', get_stylesheet_directory_uri() . '/assets/css/classic.time.css', array(), _S_VERSION);
    ...
    // wp_enqueue_script('datepicker-time', get_template_directory_uri() . '/assets/js/picker.time.js', array(), _S_VERSION, true);
}
