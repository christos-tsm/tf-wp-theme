...
function taxi_transfer_scripts() {
    ...
    wp_enqueue_style('lightbox-css', get_stylesheet_directory_uri() . '/assets/css/lightbox/lightbox.min.css', array(), _S_VERSION);
    wp_style_add_data('taxi-transfer-style', 'rtl', 'replace');

    wp_enqueue_script('jquery');
    wp_enqueue_script('lightbox-js', get_template_directory_uri() . '/js/lightbox/lightbox.min.js', array(), _S_VERSION, true);
